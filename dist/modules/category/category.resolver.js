...
__decorate([
    (0, graphql_1.Query)(returns => [category_1.Category], { name: 'getAllCategories' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], CategoryResolver.prototype, "getAllCategories", null);
__decorate([
    (0, graphql_1.Mutation)(returns => Boolean, { name: 'removeCategory' }),
...
__decorate([
    (0, graphql_1.Mutation)(returns => category_1.Category, { name: 'updateCategory' }),
    __param(0, (0, graphql_1.Args)('id')),
...
__decorate([
    (0, graphql_1.Mutation)(returns => category_1.Category, { name: 'createCategory' }),
...
CategoryResolver = __decorate([
    (0, graphql_1.Resolver)(of => category_1.Category),
